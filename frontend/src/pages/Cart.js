...
function placeOrderHandler(){
  ...
  return (
   ...
   cartItems.length > 0 ? <Fragment>
                                ...
                                <div className="cart-item">
                                    <div className="row">
                                        ...
                                        <div  className="col-4 col-lg-1 mt-4 mt-lg-0">
                                            <i onClick={()=>deleteCartItem(item)} id="delete_cart_item" className="fa fa-trash btn btn-danger"></i>
                                        </div>
                 ...
                 </Fragment> : (!complete) ? <h1 className='mt-5'>Your Cart is Empty</h1> : <Fragment>
